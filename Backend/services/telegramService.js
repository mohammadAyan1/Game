...
//         {
//           text: "✅ ACCEPT",
//           callback_data: `accept:${txnId}`,
//         },
//         {
//           text: "❌ REJECT",
//           callback_data: `reject:${txnId}`,
//         },
//       ],
//     ],
//   };
...
// export async function sendPaymentProof({ txnId, amount, coins, utrNumber, screenshotBuffer, screenshotMimeType, userName }) {
//   try {
...
//       if (data.ok) sentMsgId = data.result.message_id;
//       else console.error("Telegram sendPhoto error:", data);
//     } else {
//       // Send text only (UTR only, no screenshot)
...
//       const data = await res.json();
//       if (data.ok) sentMsgId = data.result.message_id;
//       else console.error("Telegram sendMessage error:", data);
//     }
...
// // ─── Edit message after admin action ─────────────────────────────────────────
// export async function editAdminMessage({ msgId, txnId, amount, coins, utrNumber, userName, action, remark }) {
//   try {
//     const statusLine =
//       action === "accept"
...
//     // Try editMessageCaption (if it was a photo message)
...
//     // If it was a text message (no photo), fall back to editMessageText
//     if (!data.ok) {
...
//     if (!data.ok) console.error("Telegram edit error:", data);
//   } catch (err) {
//     console.error("Telegram editMessage error:", err);
//   }
// }

// // ─── Send simple text to admin ────────────────────────────────────────────────
