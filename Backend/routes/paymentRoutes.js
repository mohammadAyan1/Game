...
// // Multer — memory storage (screenshot buffer)
// const upload = multer({
...
// // New: user submits payment proof (screenshot + UTR)
// router.post("/submit-proof", upload.single("screenshot"), submitProof);

// // New: Telegram bot webhook callback (admin accept/reject)
// router.post("/telegram-webhook", adminCallback);

// // New: Frontend polls this to know if admin has acted
...
// ║  Payment se related saare routes                    ║
// ╚══════════════════════════════════════════════════════╝
