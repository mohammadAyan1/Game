...
//     `SELECT t.*, b.* FROM transactions as t
...
//     "UPDATE transactions SET user_id=? WHERE id = ? ", [userId, req.params.id]
//   )
...
// ╔══════════════════════════════════════════════════════╗
// ║  FILE: backend/src/controller/transactionController.js ║
// ║  Transaction create, fetch, status                  ║
// ╚══════════════════════════════════════════════════════╝
