...
// ── 4. Telegram Webhook — Admin Accept/Reject ──────────────────────────────
// ✅ FIXED: Respond immediately to Telegram, process in background
export const adminCallback = (req, res) => {
  // 🚀 Send 200 OK instantly – Telegram needs fast response
  res.sendStatus(200);

  // 🔄 Process the update in background (don't block the response)
