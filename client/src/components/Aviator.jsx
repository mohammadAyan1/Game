...
export default function Aviator() {
    ...
    const handleCashout = useCallback(() => {
        if (phase === "flying") setCashout(multiplier)
    }, [phase, multiplier])
        ...
        >
            ...
            <div
                ...
                style={{
                    ...
                    boxShadow: `
                        0 0 0 1px #D4A84715 inset,
                        0 50px 130px #00000095,
                        0 0 80px #D4A8470C
                    `,
                }}
            >
                    ...
                    <div className="flex items-center gap-3">
                        <svg width="26" height="26" viewBox="0 0 26 26" style={{ flexShrink: 0 }}>
                            <polygon points="13,1 25,13 13,25 1,13"
                                fill="none" stroke={GOLD} strokeWidth="1.25" />
                            <polygon points="13,6 20,13 13,20 6,13"
                                fill={GOLD} fillOpacity="0.2" stroke={GOLD} strokeWidth="0.6" />
                        </svg>
                        <span style={{
                    ...
                    <svg width={W} height={H} viewBox={`0 0 ${W} ${H}`}
                        ...
                        {Y_TICKS.map(({ y, label }) => (
                            <g key={label}>
                                <line x1={PAD.left} y1={y} x2={W - PAD.right} y2={y}
                                    stroke="#D4A8470A" strokeWidth="1" />
                                <text x={PAD.left - 10} y={y + 4}
                                    textAnchor="end" fill="#D4A84745"
                        ...
                        {X_TICKS.map(({ x, label }) => (
                            <g key={label}>
                                ...
                                <text x={x} y={H - PAD.bottom + 16}
                                    textAnchor="middle" fill="#D4A84738"
                        ...
                        {phase !== "waiting" && (
                            ...
                            >
                                ...
                                <line x1="0" y1="5"
                                    x2="0" y2={H - PAD.bottom - tip.y - 5}
                                    stroke={gradColor} strokeWidth="1"
                        ...
                        <text
                            ...
                            fontSize={crashed ? "52" : "60"}
                            fontWeight="700"
                            fontFamily="'Cinzel', serif"
                            fill={crashed ? RED_CRASH : gradColor}
                            filter="url(#glow)"
                            style={{
                                opacity: phase === "waiting" ? 0.22 : 1,
                                transition: "fill 0.3s, font-size 0.15s",
                            }}
                        >
                        ...
                        <text
                            ...
                            fontSize="10"
                            fontFamily="'Space Mono', monospace"
                            fill={crashed ? `${RED_CRASH}99` : "#D4A84748"}
                            letterSpacing="5"
                        >
                        ...
                        {cashout && phase === "flying" && (
                            <g transform={`translate(${W / 2}, ${H / 2 - 76})`}>
                                <rect x="-88" y="-17" width="176" height="34" rx="6"
                                    fill="#D4A84712"
                                    stroke={GOLD} strokeWidth="0.75" strokeOpacity="0.55" />
                                <text textAnchor="middle" dominantBaseline="middle"
                                    fontSize="12" fill={GOLD} fontWeight="700"
                                    fontFamily="'Space Mono', monospace">
                ...
                <div className="flex items-end gap-5 flex-wrap px-6 py-5">
                    ...
                    <button
                        ...
                        style={{
                            ...
                            minWidth: "170px",
                            transition: "all 0.2s",
                            cursor: phase !== "flying" || cashout ? "not-allowed" : "pointer",
                ...
                {cashout && (
                    <div style={{
                        ...
                        &nbsp;—&nbsp;Win:&nbsp;
                        <strong style={{ color: GOLD_BRIGHT }}>₹{(Number(betAmount) * cashout).toFixed(2)}</strong>
                        &nbsp;&nbsp;✦
                    </div>
                )}
